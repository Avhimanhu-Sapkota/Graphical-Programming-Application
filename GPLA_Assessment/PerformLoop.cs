...
namespace GPLA_Assessment
{
    ...
    public class PerformLoop
    {
        ...
        public bool checkLoopCommand(String enteredCode, int lineCounter)
        {
            ...
            if (command.Length != 2)
            {
                ...
                Canvas.errorList.Add("ERROR!!! AT LINE " + lineCounter + ". Please Enter While Statement in Correct Syntax");
            }
            ...
            if (command[0].Equals("while"))
            {
                ...
                if (command.Length == 2)
                {
                    ...
                    loopCommandFlag = executeLoopCommand(loopOperator, loopCondition, lineCounter);
                }
            }
        ...
        public bool executeLoopCommand(String loopOperator, String loopCondition, int lineCounter)
        {
        ...
        public void runLoop(int lineCounter, bool syntaxButton, String whileCommand, ArrayList canvasList)
        {
            ...
            while (loopConditionFlag)
            {
                ...
                loopConditionFlag = checkLoopCommand(whileCommand, lineCounter);
            }
        }
    }
}
